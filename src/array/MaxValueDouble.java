...
public class MaxValueDouble {
    static int max ;
    static int[] myList = new int[2];

    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        System.out.println("Array las index: " + (myList.length-1));
        max = myList[0];
        System.out.println("Enter " + myList.length + " Values or -1 to end: ");
        ...
        for (int i = 0; i < myList.length; i++) {
            ...
            for (int e : myList) System.out.print(e+ " ");
            max(myList);
        }
        input.close();
    ...
    public static int[] doubleArray(int[] list){
        ...
        System.out.println("New array size: " +newList.length);
